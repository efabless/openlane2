...
flow_variables = [
    ...
    Variable(
        ...
        bool,
        "Allows tie separation when performing resizer design optimizations.",
        default=False,
    ),
    Variable(
        "DONT_USE_CELLS",
    ...
    Variable(
        ...
        bool,
        "Specifies whether or not to insert buffers on input ports whenever resizer optimizations are run. For this to be used, `RUN_POST_GPL_RESIZER_DESIGN` must be set to 1.",
        default=True,
    ),
    Variable(
        "PL_RESIZER_BUFFER_OUTPUT_PORTS",
        bool,
        "Specifies whether or not to insert buffers on output ports whenever resizer optimizations are run. For this to be used, `RUN_POST_GPL_RESIZER_DESIGN` must be set to 1.",
        default=True,
    ),
    Variable(
        "PL_RESIZER_REPAIR_TIE_FANOUT",
        bool,
        "Specifies whether or not to repair tie cells fanout whenever resizer optimizations are run. For this to be used, `RUN_POST_GPL_RESIZER_DESIGN` must be set to 1.",
        default=True,
    ),
    Variable(
    ...
    Variable(
        "RUN_POST_GPL_RESIZER_DESIGN",
        bool,
        "Specifies whether post-global placement resizer design optimizations should be performed or not.",
        default=True,
        deprecated_names=["PL_RESIZER_DESIGN_OPTIMIZATIONS"],
    ),
    Variable(
        "RUN_POST_DPL_RESIZER_TIMING",
        bool,
