...
process node
    ...
    A semiconductor manufacturing process executed by a certain chip fabricator,
...
DRC
    ...
    Rules set by a chip fabricator for a certain chip manufacturing process that
